...
const SpecialOfferScreen = () => {
  ...
  return (
    <View style={styles.container}>
      ...
      <Text style={styles.subtitle}>Get Limited Special Discount Up to 40% All Salons near You!</Text>
      <Image
        source={{ uri: 'https://via.placeholder.com/200' }}
        style={styles.image}
      />
      <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('TopRatedSalons')}>
